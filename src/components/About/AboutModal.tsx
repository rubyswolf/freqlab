      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="w-20 h-20 bg-bg-tertiary rounded-2xl flex items-center justify-center mb-4 overflow-hidden">
          <svg className="w-20 h-20" viewBox="0 0 1024 1024" fill="none">
            <defs>
              <linearGradient id="aboutWaveGrad" x1="200" y1="200" x2="824" y2="824" gradientUnits="userSpaceOnUse">
        ...
        <div className="flex gap-3 mb-6">
          <a
            ...
            title="X (Twitter)"
          >
            <svg className="w-5 h-5 text-text-secondary hover:text-text-primary" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            ...
            title="Website"
          >
            <svg className="w-5 h-5 text-text-secondary hover:text-text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0112 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 013 12c0-1.605.42-3.113 1.157-4.418" />
            </svg>
          </a>
        </div>
        ...
        <p className="text-text-secondary text-sm mb-4">
          freqlab uses <span className="text-text-primary font-medium">nih-plug</span> for VST/CLAP plugin development.
        </p>
        ...
        <div className="w-full space-y-2 mb-6">
          ...
          {termsOpen && (
            <div className="p-3 bg-bg-tertiary rounded-lg text-left space-y-3 max-h-36 overflow-y-auto">
              <div>
                <h4 className="text-xs font-semibold text-text-primary uppercase tracking-wide mb-0.5">License</h4>
                <p className="text-xs text-text-secondary">
                  freqlab is licensed under GPL-3.0. Source available at{' '}
                  <a href="https://github.com/jamesontucker/freqlab" target="_blank" rel="noopener noreferrer" className="text-accent hover:text-accent-hover">
                    GitHub
                  </a>
                </p>
              </div>
              ...
              <div>
                <h4 className="text-xs font-semibold text-text-primary uppercase tracking-wide mb-0.5">No Warranty</h4>
                <p className="text-xs text-text-secondary">
